...
public class UserDTO {
    ...
    public UserDTO(long id, String password, String code, Person person, Set<Rol> authorities, Status status) {
        this.id = id;
        this.person = person;
    ...
    public UserDTO(String password, String code, Person person, Set<Rol> authorities, Status status) {
        this.password = password;
        this.person = person;
        this.username = person.getEmail();
        this.code = code;
